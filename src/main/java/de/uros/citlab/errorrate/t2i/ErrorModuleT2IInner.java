...
//    private PathFilterBaselineMatch filter;
...
//        this(allowSegmentationErrors, true);
//    }
//
//    ErrorModuleT2IInner(boolean allowSegmentationErrors, boolean allowJumps) {
//        fallback = allowJumps ? new ErrorModuleT2IInner(allowSegmentationErrors, false) : null;
...
//                }
//            } else {
//                pathCalculator.addCostCalculator(new CCDelLine(voter, false));
//            }
//        } else {
//            if (allowJumps) {
...
//                }
//            } else {
//                pathCalculator.addCostCalculator(new CCDelLine(voter, true));
//            }
//        }
////        this.filter = null;
...
//        pathCalculator.setDynMatViewer(dynMatViewer);
//        if (fallback != null) {
//            fallback.setDynMatViewer(dynMatViewer);
//        }
//    }
//
//
...
//    }
//
////    public int[] getOracleCounts(List<? extends ILine> reco, List<? extends ILine> ref) {
////        AlignmentTask lmr = new AlignmentTask(reco, ref, tokenizer, stringNormalizer, thresholdCouverage);
////        return lmr.getMaxPrec();
////    }
//
//    @Override
...
//        AlignmentTask lmr = new AlignmentTask(reco, ref, tokenizer, stringNormalizer, thresholdCouverage);
//        return calculateIntern(lmr, calcLineComarison);
//    }
//
//    /**
...
//    }
//
//    private List<ILineComparison> calculateIntern(AlignmentTask alignmentTask, boolean calcLineComparison) {
//        PathCountResult pathCountResult = getPathCountResult(alignmentTask, calcLineComparison);
...
//            this.error = error;
//            this.startReco = Math.max(0, startReco);
//            this.endReco = endReco;
//            this.startRef = Math.max(0, startRef);
//            this.endRef = endRef;
//            this.path = path;
...
//                            //have to be INS or DEL in all paths
//                            switch (elements.get(0).getManipulation()) {
//                                case "INS": {
//                                    PathCalculatorGraph.IDistance<String, String> el = elements.get(0);
//                                    return new PathQuality(
...
//    }
//
//    private PathCountResult getPathCountResult(AlignmentTask alignmentTask, boolean calcLineComparison) {
...
//        //all reference were not found, add all characters as insertion
...
//        }
//        //skipping of reference lines should not be counted
//        if (countChars(refs) == 0) {
//            PathCountResult pathCountResult = new PathCountResult();
////            for (int i = 0; i < recos.length; i++) {
////                if (!voter.isLineBreak(recos[i])) {
////                    pathCountResult.add(new Substitution("", recos[i]), Count.HYP, Count.DEL);
////                    if (calcLineComparison) {
////                        pathCountResult.add(
////                                getLineComparison(
////                                        alignmentTask.getRecoLineMap()[i],
////                                        -1,
////                                        recos[i],
////                                        "",
////                                        Arrays.asList(new Point(Manipulation.DEL, recos[i], ""))
////                                )
////                        );
////                    }
////                }
...
//        if (grouping.isEmpty()) {
//            pathCountResult.addAll(getPathCountResultFallback(alignmentTask, calcLineComparison));
//            return pathCountResult;
//        }
...
//            return pathCountResult;
//        }
//        //if nothing could counted subproblem would be the same: try fallback
//        if (pathCountResult.getCounter().isEmpty()) {
//            pathCountResult.addAll(getPathCountResultFallback(alignmentTask, calcLineComparison));
//            return pathCountResult;
//        }
//
...
//        }
//
//        pathCountResult.addAll(getPathCountResult(subProblem, calcLineComparison));
//        return pathCountResult;
//    }
//
//    private final ErrorModuleT2IInner fallback;
//
//    private PathCountResult getPathCountResultFallback(AlignmentTask alignmentTask, boolean calcLineComparison) {
//        LOG.warn("fallback - probably ending into infinity loop");
//        return fallback.getPathCountResult(alignmentTask, calcLineComparison);
//
//    }
//
